...
public:
    ...
    strategy_launch_rules() {}
    ~strategy_launch_rules() {}
    void add_date(int year, int month, int day);
    std::string to_string() const;
    void set_date_range();
    boost::optional<strategy_launch_rules::bdate> getStartDate() const;
    void setStartDate(int year, int month, int day);
    boost::optional<strategy_launch_rules::bdate> getEndDate() const;
